...
function TopSellerProductsContent() {
    ...
    return (
        <div className='w-full bg-[#F2F2F2] h-[85vh]'>
            <div className='flex justify-between items-center bg-[#0C705F] text-white py-3 px-[5%] '>
                <div className='hidden md:flex lg:flex xl:flex items-center'>
                    <Image src={headset} alt="img" />
                    <p className={`${manrope.className} text-[12px] md:text-[14px] lg:text-[14px] xl:text-[14px] ml-2`}>Help: 0906 710 8888</p>
                </div>
    ...
    return (
        <Suspense fallback={
            <div className="min-h-screen flex items-center justify-center bg-white p-4">
                <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#0C705F]"></div>
            </div>
        }>
            <TopSellerProductsContent />
        </Suspense>
    );
}
