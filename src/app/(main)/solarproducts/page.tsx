...
function SolarProductsContent() {
    ...
    const solarProducts = data ? JSON.parse(data) : null;
        ...
        <div className='w-full bg-[#F2F2F2] h-[85vh]'>
            <div className='flex justify-between items-center bg-[#FFC300] text-white py-3 px-[5%] '>
                ...
                <div className='flex items-center'>
                    <p className={`${manrope.className} text-[12px] md:text-[14px] lg:text-[14px] xl:text-[14px] ml-2 text-[#000000]`}>Solar Deals</p>
                </div>
            ...
            <div className="bg-white w-full md:w-[90%] lg:w-[90%] xl:w-[90%] mx-auto mt-0 md:mt-3 lg:mt-3 xl:mt-3 p-3">
                ...
                <div className='bg-white'>
                    <ProductCard products={solarProducts} />
                </div>
            </div>
        </div>
    );
