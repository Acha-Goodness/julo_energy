    ...
    return (
        <div className='w-full bg-[#F2F2F2] h-[85vh]'>
            <div className='flex justify-between items-center bg-[#EBF1F2] text-white py-3 px-[5%] '>
                ...
                <div className='flex items-center'>
                    <p className={`${manrope.className} 14px ml-2 text-[#000000]`}>{categoryName}</p>
                </div>
                <p className={`${manrope.className} text-[17px] text-transparent`}>Time Left: <span className={`font-bold`}>02h : 28m : 02s</span></p>
            </div>
